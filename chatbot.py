...
ques=[]
ans=[]
filename='files/convo'+str(filecount)+'.txt'
...
print "Bot: it was nice chatting to you\n"
...
print "\nBot: and dont forget to delete google cookie or just eat it if its present"
print "\nBot: thank you for waiting, bye now, hope to see you again :)"
